...
public class AuthorizationService : IAuthorizationService
{
    ...
    public ErrorOr<Success> AuthorizeCurrentUser<T>(IAuthorizableRequest<T> request, List<string> requiredRoles, List<string> requiredPermissions, List<string> requiredPolicies)
    {
